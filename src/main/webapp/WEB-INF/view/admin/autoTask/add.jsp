...
<div class="container-fluid">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">自动任务新增</h1>
	    </div><!-- /.col-lg-12 -->
	</div><!-- /.row -->
	<div class="row">
	    <div class="col-lg-12">
	            ...
	            <div class="panel-body">
                    <form role="form" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="taskName" name="taskName" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="clazz" class="col-sm-2 control-label">任务类</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="clazz" name="clazz" placeholder="com.noisyle.crowbar.task.Task1" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="parameter" class="col-sm-2 control-label">执行参数</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="parameter" name="parameter" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cron" class="col-sm-2 control-label">执行时间</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="cron" name="cron" placeholder="*/10 * * * * ?" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="enable" class="col-sm-2 control-label">是否启用</label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" id="enable" name="enable" value="false" required>
                            </div>
                        </div>
